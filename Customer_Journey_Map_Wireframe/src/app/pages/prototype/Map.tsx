...
import { Search, Filter, Navigation, Star, Clock, Phone, Home, Map, Calendar, User, X } from "lucide-react";
          ...
          <div className="bg-neutral-800 rounded-[3rem] p-4 shadow-2xl">
            <div className="bg-white rounded-[2.5rem] overflow-hidden">
              <div className="h-[700px] flex flex-col relative">
                {/* Status Bar */}
                <div className="absolute top-0 left-0 right-0 px-8 pt-4 pb-2 z-10 bg-gradient-to-b from-white to-transparent">
                ...
                {/* Map Area */}
                <div className="flex-1 relative bg-gradient-to-br from-emerald-50 via-green-50 to-blue-50">
                  {/* Simplified map grid */}
                  ...
                  {/* Place detail card */}
                  {selectedPlaceData && (
                    <div className="absolute bottom-20 left-4 right-4 z-30 bg-white rounded-2xl shadow-2xl border border-neutral-200">
                      <div className="p-4">
                ...
                {/* Bottom Navigation */}
                <div className="border-t border-neutral-200 bg-white z-40">
